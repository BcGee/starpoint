...
function serializeMail(mail: PlayerMail) {
    ...
    return {
        ...
        // str8 avoidance: msgpackr emits str8 (0xd9) for 32-255 byte strings, which
        // the old Flash/AIR client can't decode. Truncate long descriptions to stay
        // under 32 bytes (str fixstr) until the msgpackr str8→str16 fix lands.
